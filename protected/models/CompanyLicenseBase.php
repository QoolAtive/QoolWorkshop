 ...
 */
class CompanyLicenseBase extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('company_id, license_th, license_en, license_number', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'company_id' => 'Company',
			'license_th' => 'License Th',
			'license_en' => 'License En',
