 ...
 */
class WebShopPay extends WebShopPayBase
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'account_bank' => Yii::t('language', 'ชื่อธนาคาร'),
			'account_name' => Yii::t('language', 'ชื่อบัญชี'),
			'account_number' => Yii::t('language', 'เลขที่บัญชี'),
			'pay_ems' => 'Pay Ems',
			'pay_byself' => 'Pay Byself',
			'location' => Yii::t('language', 'สถานที่นัดพบ'),
			'tel' => Yii::t('language', 'เบอร์โทรติดต่อ'),
			'pay_other' => 'Pay Other',
