 ...
 *
 * The followings are the available columns in table 'site_map':
 * @property integer $site_map_id
 ...
 */
class SiteMapBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SiteMapBase the static model class
	 */
