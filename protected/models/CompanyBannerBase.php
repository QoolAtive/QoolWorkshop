 ...
 *
 * The followings are the available columns in table 'company_banner':
 * @property integer $company_banner_id
 * @property integer $com_id
 * @property string $path
 */
class CompanyBannerBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CompanyBannerBase the static model class
	 */
