...
/**
 * This is the model class for table "learning_file".
 *
 * The followings are the available columns in table 'learning_file':
 * @property integer $id
 * @property integer $main_id
 * @property string $path
 */
class LearningFileBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LearningFileBase the static model class
	 */
