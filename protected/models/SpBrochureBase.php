...
/**
 * This is the model class for table "sp_brochure".
 *
 * The followings are the available columns in table 'sp_brochure':
 * @property integer $brochure_id
 * @property integer $com_id
 * @property string $path
 */
class SpBrochureBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SpBrochureBase the static model class
	 */
