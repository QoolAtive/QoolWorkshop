...
/**
 * This is the model class for table "sp_log".
 *
 * The followings are the available columns in table 'sp_log':
 * @property integer $sp_log_id
 * @property integer $user_id
 * @property integer $service_company_id
 */
class SpLogBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SpLogBase the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('sp_log_id, user_id, service_company_id', 'safe', 'on'=>'search'),
		);
	}
