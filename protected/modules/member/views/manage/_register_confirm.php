<div class="form">
    <h3 class="barH3">
        <i class="icon-lock"></i> <?php echo Yii::t('language', 'ยืนยันการสมัครสมาชิก'); ?></h3>
    ...
    <div class=" textcenter buttons">
        <?php echo CHtml::submitButton(Yii::t('language', 'ยืนยัน'), array('id' => 'submit', 'style' => 'width:300px;')); ?>
    </div>
