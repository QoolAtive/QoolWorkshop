...
//
                ...
                if ($arr_files != NULL) {
                    if ($model->background != NULL) {
                        if (fopen('.' . $model->background, 'w')) {
                            unlink('.' . $model->background);
                        }
                    }
...
//END for upload bg pic
                ...
                if ($valid_logo || $valid_bg) {
                    ...
                    echo "<script language='javascript'>
                        alert('" . Yii::t('language', 'บันทึกข้อมูลเรียบร้อย') . "');
                        window.top.location.href = '" . CHtml::normalizeUrl(array('/webSimulation/manageShop/selectLogoBg')) . "';
                  </script>";
                }
            }
    ...
    public function actionDeleteLogo() {
        ...
        WebShopFormat::model()->updateByPk($model->web_shop_format_id, array('logo' => NULL));
        echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> ';
        echo "<script language='javascript'>
                alert('" . Yii::t('language', 'ลบโลโก้เรียบร้อย') . "');
                        window.top.location.href = '/webSimulation/manageShop/selectLogoBg';
                </script>";
    }
    ...
    public function actionDeleteBg() {
        ...
        WebShopFormat::model()->updateByPk($model->web_shop_format_id, array('background' => NULL));
        echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> ';
        echo "<script language='javascript'>
                alert('" . Yii::t('language', 'ลบพื้นหลังเรียบร้อย') . "');
                        window.top.location.href = '/webSimulation/manageShop/selectLogoBg';
                </script>";
    }
...
//    หน้าแสดงรายละเอียดใบสั่งซื้อ
    public function actionOrderDetail($order_id) {
        ...
        if (isset($_POST['status'])) {
            ...
            echo "<script language='javascript'>
                alert('" . Yii::t('language', 'บันทึกข้อมูลเรียบร้อย') . "');
                window.top.location.href = '" . CHtml::normalizeUrl(array('/webSimulation/manageShop/orderDetail', 'order_id' => $order_id)) . "';
                </script>";
        }
...
//เปลี่ยนเป็นซ่อน
            ...
            echo "<script language='javascript'>
            alert('" . Yii::t('language', 'ซ่อน') .Yii::t('language', 'กล่องแสดงสินค้า'). Yii::t('language', 'เรียบร้อย') . "');
            window.top.location.href = '" . CHtml::normalizeUrl(array('/webSimulation/manageShop/manageBox')) . "';</script>";
        } else {
//เปลี่ยนเป็นโชว์
            WebShopBox::model()->updateByPk($box_id, array('show_box' => '1'));
            echo "<script language='javascript'>
            alert('" . Yii::t('language', 'แสดง').Yii::t('language', 'กล่องแสดงสินค้า')  . Yii::t('language', 'เรียบร้อย') . "');
            window.top.location.href = '" . CHtml::normalizeUrl(array('/webSimulation/manageShop/manageBox')) . "';</script>";
        }
    }
