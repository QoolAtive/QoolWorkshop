...
foreach ($faq_sub_list as $faq_sub) {
    ...
    $criteria->condition = "faq_sub_id = " . $faq_sub['faq_sub_id'];
        ...
        foreach ($faq_list as $faq) {
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <p class="faqarrow"></p>
                    <a class="accordion-toggle" id="subject<?php echo $i; ?>" data-toggle="collapse" data-parent="#hideother<?php echo $main_id; ?>" href="#item<?php echo $main_id . $i; ?>" onclick="addHit('<?php echo $this->createAbsoluteUrl('/faq/default/countView', array('faq_id' => $faq['id'])); ?>');">
                        <?php echo $subject; ?>
                    </a>
                </div>
                <div id="item<?php echo $main_id . $i; ?>" class="accordion-body collapse <?php
//                if ($i == 1)
//                    echo 'in';
//                else
//                    echo '';
