...
<?php
$list = array(
    array('text' => Yii::t('language', 'Learning Groups'), 'link' => '/knowledge/default/index', 'select' => $select1),
        ...
        <div id="view2" class="tabcontent ">
            ...
            <ul class="clearfix">
                ...
                <li style="width: 70%; float: left;">
                    ...
                    <?php echo Tool::limitString(preg_replace('/(<[^>]+) style=".*?"/i', '$1', ereg_replace('&nbsp;', ' ', $lessonNext->detail)), 150); ?>
                </li>
            </ul>
            <div>
                <?php
