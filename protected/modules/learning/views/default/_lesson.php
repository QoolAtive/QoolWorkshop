...
<div class="content">
    <div class="tabcontents">
        ...
        <iframe width="745" height="415" src="<?php echo $modelVideo->video; ?>?showinfo=0"   frameborder="0" allowfullscreen></iframe>
        ...
        <?php if (!empty($lessonNext)) { ?>
            ...
            <ul class="nextlearn">
                <li>
                    <iframe width="210px" src="<?php echo $lessonNextVideo->video; ?>?showinfo=0" frameborder="0" allowfullscreen></iframe>
