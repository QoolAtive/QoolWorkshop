$(document).ready(function() {
    var config = {
        siteURL: 'http://www.dbdmart.com/', // Change this to your site
//        siteURL: 'http://dev.dbd.qoolative.com/', // Change this to your site
        searchSite: true,
        type: 'web',
        append: true,
...
//                    });
        ...
        if (settings.searchSite) {
            ...
            // specific domain:
            console.log('1: ' + settings.term);
            settings.term = 'site:' + settings.siteURL + ' ' + settings.term;
            console.log('2: ' + settings.term);
        }

        // URL of Google's AJAX search API
        var apiURL = 'http://ajax.googleapis.com/ajax/services/search/' + settings.type + '?v=1.0&callback=?';
//		var resultsDiv = $('#resultsDiv');
        var resultsDiv = $('#container');
