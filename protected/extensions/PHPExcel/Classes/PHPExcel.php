...
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'PHPExcel/Worksheet.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'PHPExcel/DocumentProperties.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'PHPExcel/DocumentSecurity.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'PHPExcel/Style.php';
