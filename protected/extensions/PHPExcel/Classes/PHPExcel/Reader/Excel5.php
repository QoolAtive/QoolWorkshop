...
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'IReader.php';

require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Cell.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Chart.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Calculation.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Comment.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../DocumentProperties.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../DocumentSecurity.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../HashTable.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../NamedRange.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../ReferenceHelper.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../RichText.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Settings.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Style.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Worksheet.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../WorksheetIterator.php';





require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/OLERead.php'; //PHPExcel_Reader_IReader
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/CodePage.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/OLE.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/Date.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/Drawing.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/Escher.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/Excel5.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/File.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/Font.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/PasswordHasher.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/String.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/XMLWriter.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/ZipArchive.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'../Shared/ZipStreamWrapper.php';
