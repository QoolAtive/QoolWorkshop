...
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Style/Alignment.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Style/Border.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Style/Borders.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Style/Color.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Style/Conditional.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Style/Fill.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Style/Font.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Style/NumberFormat.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Style/Protection.php';
