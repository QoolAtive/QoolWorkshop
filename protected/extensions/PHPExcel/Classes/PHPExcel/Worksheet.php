...
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'IComparable.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'CachedObjectStorageFactory.php';
...
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/BaseDrawing.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/CellIterator.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/ColumnDimension.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/Drawing.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/HeaderFooter.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/HeaderFooterDrawing.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/MemoryDrawing.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/PageMargins.php';

require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/PageSetup.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/Protection.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/Row.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/RowDimension.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/RowIterator.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'Worksheet/SheetView.php';
